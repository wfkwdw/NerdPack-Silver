...
local legionEvents = {
	...
	-- Karazhan
	{ 'Demon Spikes', 'player.buff.duration & player.debuff(Dent Armor) & !player.lastcast'},
...
local activeMitigation = {
	-- Demon Spikes
	{ 'Demon Spikes', 'player.spell(Demon Spikes).charges = 2 & !player.buff & target.range <= 8 & target.threat == 100'},
}
